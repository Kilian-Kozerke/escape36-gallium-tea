...
Total annual cost is the sum of four blocks (CO₂ tax excluded in ESCAPE baseline):

  TC = AF × CapEx  +  OpEx  +  REP  +  LC               [EUR/yr]
